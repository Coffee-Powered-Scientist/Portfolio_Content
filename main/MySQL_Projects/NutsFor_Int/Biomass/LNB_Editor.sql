...
describe LNB_Biomass;
-- Test out with a manually loaded .csv first
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\NutsFor_Data\\Biomass_Data\\Raw_Data\\LNB\\Tree data.csv'
INTO TABLE LNB_Biomass
...
-- This inserts the original LNB_Biomass Table into the new Organ_Table, splitting up named elements into the different columns
INSERT INTO Organ_Table_2 (YEAR, Month, Site, Biomass_Type, M_Type, Ca, Mg, N, K, S, P)
...
INSERT INTO DW_Table_2 (YEAR, Month, Site, Biomass_Type, DW)
...
UPDATE Organ_Table_2 SET Site = 'LNB';
SET SQL_SAFE_UPDATES = 1;

SET SQL_SAFE_UPDATES = 0;
UPDATE DW_Table_2 SET Site = 'LNB';
SET SQL_SAFE_UPDATES = 1;

Select * FROM Organ_Table_2;  -- Check import results, check1 should be an empty column (also, the upload doesn't work without check1